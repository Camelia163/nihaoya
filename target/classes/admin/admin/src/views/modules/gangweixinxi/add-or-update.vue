			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.gangweiyaoqiu = this.ruleForm.gangweiyaoqiu.replace(reg,'../../../work_study/upload');
						this.ruleForm.gangweijianjie = this.ruleForm.gangweijianjie.replace(reg,'../../../work_study/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
