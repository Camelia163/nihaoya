	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="学生账号" prop="xueshengzhanghao" style="display:none">
					<el-input v-model="ruleForm.xueshengzhanghao" placeholder="学生账号" clearable  :readonly="ro.xueshengzhanghao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="学生账号" prop="xueshengzhanghao" style="display:none">
