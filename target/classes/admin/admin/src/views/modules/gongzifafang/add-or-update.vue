	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'" label="学生账号" prop="xueshengzhanghao" style="display:none">
				...
				<el-form-item class="input" v-else-if="ruleForm.xueshengzhanghao" label="学生账号" prop="xueshengzhanghao" style="display:none">
