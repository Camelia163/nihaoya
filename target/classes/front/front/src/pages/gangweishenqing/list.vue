	...
	<div>
		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('gangweishenqing','新增')" type="primary" @click="add('/index/gangweishenqingAdd')">
						...
						<div class="item-info">
							<div>
								...
								<div class="publisher_item">
									...
									<span class="text">{{item.xueshengzhanghao}}</span>
								</div>
							</div>
						</div>
					</div>
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`gangweishenqing/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/gangweishenqingDetail', query: params});
			},
