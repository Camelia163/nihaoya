	...
	<div class="main-containers">
		<div class="body-containers">
			<div class="top-container">
				<!-- info -->
				<div class="top_title">
					<span @click="goMenu('/index/home')">勤工助学管理系统</span>
				</div>
	...
	methods: {
		...
		async getSession() {
			await this.$http.get(`${localStorage.getItem('UserTableName')}/session`, {emulateJSON: true}).then(async res => {
				if (res.data.code == 0) {
					if(localStorage.getItem('UserTableName')== 'xuesheng') {
						localStorage.setItem('username', res.data.data.xueshengzhanghao);
					}
					if(localStorage.getItem('UserTableName')== 'yonggongdanwei') {
						localStorage.setItem('username', res.data.data.danweizhanghao);
					}
